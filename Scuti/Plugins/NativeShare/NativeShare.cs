...
public class NativeShare
{
	...
	public NativeShare AddFile( string filePath, string mime = null )
	{
		if( !string.IsNullOrEmpty( filePath ) && File.Exists( filePath ) )
		{
			...
			ScutiLogger.LogError( "File does not exist at path or permission denied: " + filePath );
...
#else
		ScutiLogger.Log( "No sharing set up for this platform." );
#endif
	}
